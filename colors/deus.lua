...
colorscheme.highlight_all {
	...
	-- Messages
	Error = {fg = red, bg = bg2, bold = true, reverse = true},
	Hint = {fg = tandymagenta, bg = bg2, bold = true, reverse = true},
	Info = {fg = aqua, bg = bg2, bold = true, reverse = true},
	Todo = {fg = yellow, bg = bg2, bold = true, reverse = true},
	Warning = {fg = orange, bg = bg2, bold = true, reverse = true},
